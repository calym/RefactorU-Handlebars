...
app.get('/search', function(req, res){
	...
	"search engines" : 
	 ...
	 //console.log(data.programming[search]); //displays desc. property if the search term matches a key
	 //console.log(data["search engines"][search]); //displays desc. property if the search term matches a key


  	var description;

  if (data.programming[search]) {
    description = data.programming[search].desc;
  }

  if (data["search engines"][search]) {
    description = data["search engines"][search].desc;
  }

  if ((!data["search engines"][search]) && (!data.programming[search])) {
